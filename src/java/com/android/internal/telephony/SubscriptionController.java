    ...
    public void setDefaultDataSubId(int subId) {
        ...
        if (isDsds && !isMultiRat && len > 1) {
            for (int phoneId = 0; phoneId < len; phoneId++) {
                ...
                if (id != subId) {
                    msg = mNetworkModeHandler.obtainMessage(NetworkModeHandler.MESSAGE_SET_PREFERRED_NETWORK_TYPE, phoneId, Phone.NT_MODE_GSM_ONLY);
                    ...
                    mNetworkModeHandler.sendMessage(msg);
                    if (DBG) logdl("[setDefaultDataSubId] Set preferredNetworkType=" + networkMode);
                }
            }
        }
